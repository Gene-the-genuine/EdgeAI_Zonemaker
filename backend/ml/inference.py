            ...
            if self.predictor:
                try:
                    model_info = {
                        ...
                        'model_loaded': bool(getattr(self.predictor, 'model', None) or getattr(self.predictor, 'onnx_engine', None))
                    }
                except Exception:
                    model_info = {'model_type': 'unknown', 'model_loaded': False}
            ...
            if self.predictor:
                try:
                    model_info = {
                        'model_type': getattr(self.predictor, 'model_type', 'unknown'),
                        'model_loaded': bool(getattr(self.predictor, 'model', None) or getattr(self.predictor, 'onnx_engine', None)),
                        'model_path': getattr(self.predictor, 'model_path', 'unknown') if hasattr(self.predictor, 'model_path') else 'unknown'
                    }
                except Exception:
                    model_info = {'model_type': 'unknown', 'model_loaded': False, 'model_path': 'unknown'}
